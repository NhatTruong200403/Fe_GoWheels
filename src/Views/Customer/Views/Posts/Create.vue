    ...
    <div>
        ...
        <form @submit.prevent="submitPost">
            <div class="form-group">
                ...
                <input v-model="post.name" type="text" class="form-control" id="name" required />
            </div>
            ...
            <div class="form-group">
                <label for="images">Image List (up to 3 images)</label>
            ...
            <div class="form-group">
                ...
                <input v-model="post.seat" type="number" class="form-control" id="seat" required />
            </div>

            <!-- Rent Location -->
            <div class="form-group">
                <label for="rentLocation">Rent Location</label>
            ...
            <div class="form-group">
                ...
                <input v-model="post.pricePerDay" min="5" type="number" class="form-control" id="price" required />
            </div>
            ...
            <div class="form-group">
                <label>Gear</label>
                <div>
                    <input type="radio" v-model="post.gear" value="true" /> Automatic
                    <input type="radio" v-model="post.gear" value="false" /> Manual
                </div>
            </div>
            ...
            <!-- Fuel Consumption -->
            <div class="form-group">
                <label for="fuelConsumed">Fuel Consumption (liters/100km)</label>
        ...
        async submitPost() {
            try {
                ...
                if (response.ok) {
                    ...
                    this.$router.push({ name: 'user-post' });
